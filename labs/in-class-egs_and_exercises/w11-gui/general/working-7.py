...
csv_file_headers=[
    'day', 'date', 'year', 'time', 'home_team', 'away_team',
...
# define control variables to track click button values and counts
shots_on_target_intvar=tk.IntVar(value='0')
shots_shots_off_invar=tk.IntVar(value='0')
free_kicks_for_intvar=tk.IntVar(value='0')
free_kicks_against=tk.IntVar(value='0')
