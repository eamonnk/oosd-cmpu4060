...
class ProductNotInProdList(Exception):
    pass
...
# used lambda function to
    def remove_product(self, name):
        for items in self.shopProducts:
            if Product.name.lower() == items.lower():
                print("You have entered a valid product name. It will now be removed from the product list.")
        else:
            raise ProductNotInProdList("Product name is not on the product list. Please enter a valid product name.")
