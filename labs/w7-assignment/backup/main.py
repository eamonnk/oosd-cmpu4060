...
while num_tries_1a <= 1:
    if num_tries_1a < 1:
        p2=Product("", "tasty in 100g", 0,)
        num_tries_1a += 1
        continue
    else:
        p3=Product("pizza", "tasty in 500g slices", 0,)
        p3.print()
        break
...
while num_tries_2a <= 1:
    if num_tries_2a < 1:
        print("zzzz")
        p4=Product("coconut", "fresh daily from tropical island", -1,)
        num_tries_2a += 1
        continue
    else:
        print("vvvvv")
        p5=Product("bigcoconut", "fresh daily from tropical island", 6,)
        p5.print()
        break
# # #-- 4 --
# print(" -- 4 --")
