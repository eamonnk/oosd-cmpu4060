...
# descriptive text to explain who to use the click buttons in t he net sections
...
sports_click_buttons_desc_text_label.grid(row=7, column=0, columnspan=4, padx=4, pady=5, sticky='W, E, S, N')


# create widget  for shots ON and Off Target
sports_shots_on_target_label= ttk.Label(frame1_sports, text='Shots On Target:')
sports_shots_on_target_label.grid(row=8, column=0, padx=5, pady=5,columnspan=2, sticky='w')
...
sports_shots_on_target.grid(row=9, column=0, padx=5, pady=5,columnspan=2, sticky='w')

sports_shots_off_target_label= ttk.Label(frame1_sports, text='Shots Off Target:')
sports_shots_off_target_label.grid(row=8, column=2, padx=5, pady=5,columnspan=2, sticky='w')
...
sports_shots_off_target.grid(row=9, column=2, padx=5, pady=5, columnspan=2, sticky='w')
...
sports_free_kicks_for_label.grid(row=10, column=0, padx=5, pady=5,columnspan=2, sticky='w')
...
sports_free_kicks_for_button.grid(row=11, column=0, padx=5, pady=5,columnspan=2, sticky='w')

sports_free_kicks_against_label= ttk.Label(frame1_sports, text='Free Kicks  - Against:')
sports_free_kicks_against_label.grid(row=10, column=2, padx=5, pady=5,columnspan=2, sticky='w')
...
sports_free_kicks_against_button.grid(row=11, column=2, padx=5, pady=5, columnspan=2, sticky='w')


# create widgets for Corners For and Corners Against
sports_corners_for_label= ttk.Label(frame1_sports, text='Corners - For:')
sports_corners_for_label.grid(row=12, column=0, padx=5, pady=5,columnspan=2, sticky='w')
sports_corners_for_button=tk.Button(frame1_sports, text="Click for every Corner For", wraplength=60, underline=True, background='white')
sports_corners_for_button.grid(row=13, column=0, padx=5, pady=5,columnspan=2, sticky='w')

sports_corners_against_label= ttk.Label(frame1_sports, text='Corners - Against:')
sports_corners_against_label.grid(row=12, column=2, padx=5, pady=5,columnspan=2, sticky='w')
sports_corners_against_button=tk.Button(frame1_sports, text="Click for every Corner Against", wraplength=60, underline=True, background='white' )
sports_corners_against_button.grid(row=13, column=2, padx=5, pady=5, columnspan=2, sticky='w')

# create widgets for Goals scored and conceded
sports_goals_scored_label= ttk.Label(frame1_sports, text='Goals - Scored:')
sports_goals_scored_label.grid(row=14, column=0, padx=5, pady=5,columnspan=2, sticky='w')
...
sports_goals_scored_button.grid(row=15, column=0, padx=5, pady=5,columnspan=2, sticky='w')

sports_goals_conceded_label= ttk.Label(frame1_sports, text='Goals - Conceded:')
sports_goals_conceded_label.grid(row=14, column=2, padx=5, pady=5,columnspan=2, sticky='w')
...
sports_goals_conceded_button.grid(row=15, column=2, padx=5, pady=5, columnspan=2, sticky='w')
