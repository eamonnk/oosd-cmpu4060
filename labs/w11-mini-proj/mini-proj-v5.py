...
def sports_replace_frame():
    ...
    results_ko_time_str="KO Time: {}".format(csv_results_dict['ko time'])
    ...
    # Display the data from the dictionary in the new frame
    # for key, value in csv_results_dict.items():
    #     tk.Label(frame1a_sports_finished, text=f"{key}: {value}").grid(row=3, column=0, columnspan=2, padx=5, pady=5, sticky="w, n")
